...
if (document.getElementById('particles-js')) {
  particlesJS('particles-js', {
    particles: {
      ...
      color: {
        value: '#00FFD4'  // Electric cyan for Bio-Computing theme
      },
      shape: {
        type: 'circle',
        stroke: {
      ...
      line_linked: {
        enable: true,
        distance: 150,
        color: '#84CC16',  // Lime green connections for genomic feel
        opacity: 0.4,
        width: 1
      },
      move: {
    ...
    interactivity: {
      ...
      modes: {
        grab: {
          ...
          line_linked: {
            opacity: 1,
            color: '#00FFD4'  // Electric cyan on hover
          }
        },
        push: {
          particles_nb: 4
...
backToTopButton.style.cssText = `
  ...
  height: 50px;
  border-radius: 50%;
  background: linear-gradient(135deg, #6366F1, #00FFD4);
  color: white;
  border: none;
  cursor: pointer;
  display: none;
...
backToTopButton.addEventListener('mouseenter', () => {
  ...
  backToTopButton.style.boxShadow = '0 8px 25px rgba(0,255,212,0.6)';
});

backToTopButton.addEventListener('mouseleave', () => {
  backToTopButton.style.transform = 'translateY(0) scale(1)';
  backToTopButton.style.boxShadow = '0 4px 15px rgba(0,255,212,0.4)';
});
...
console.log('Custom scripts loaded successfully! (Bio-Computing Fusion Theme)');
